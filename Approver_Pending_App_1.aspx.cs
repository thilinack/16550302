...
public partial class Approver_Pending_App : System.Web.UI.Page
{
    static int change_id;
    Inputs input1 = new Inputs();
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["SUser_Label_Heading"] = "Pending Approvals";
        Session["Scrumble1_Heading"] = "Pending Approvals";
    }



    protected void DS_Req_To_App_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
    ...
    protected void App_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Approver_Pending_App_1.aspx");

    }


    protected void Reject_Approve_Click(object sender, EventArgs e)
    {
        input1.ApproveRejectChange(Convert.ToInt16(Session["User_ID"]), Convert.ToInt16(Session["id"]), "Rejected");
