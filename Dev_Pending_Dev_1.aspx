<%@ Page Title="" Language="C#" MasterPageFile="~/Dev_Master_1.master" AutoEventWireup="true" CodeFile="Dev_Pending_Dev_1.aspx.cs" Inherits="Dev_Pending_Dev" %>
...
where  Change.Dev_ID IS NULL and Change.BA_ID IS NOT NULL and Change.Status='BA_Qualified' and Reassign=0 and change.Dev_Assign=@Assign_ID">
              <SelectParameters>
