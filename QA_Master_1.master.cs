...
public partial class QA_Master_1 : System.Web.UI.MasterPage
{
    ...
    {
        if (Session["LoginStatus"] == null || !Convert.ToBoolean(Session["LoginStatus"]) || Convert.ToInt16(Session["SAccess_ID"]) != 6)
        {
