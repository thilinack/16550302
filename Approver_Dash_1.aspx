<%@ Page Title="" Language="C#" MasterPageFile="~/Approver_Master_1.master" AutoEventWireup="true" CodeFile="Approver_Dash_1.aspx.cs" Inherits="Approver_Dash_1" %>
...
function drawChart() {
    ...
    $.ajax({
        type: "POST",
        url: "Approver_Dash_1.aspx/GetChartData",
        data: '{}',
