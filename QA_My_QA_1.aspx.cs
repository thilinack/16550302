...
public partial class QA_My_QA: System.Web.UI.Page
{
    static int change_id;
    Inputs input1 = new Inputs();
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["SUser_Label_Heading"] = "My Qulity Checks";
        Session["Scrumble1_Heading"] = "My Quality Checks";
    }

   

    protected void DS_My_Dev_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
