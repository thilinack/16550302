<%@ Page Title="" Language="C#" MasterPageFile="~/Deployer_Master_1.master" AutoEventWireup="true" CodeFile="Deployer_Pending_Dep_1.aspx.cs" Inherits="Deployer_Pending_App" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box col-md-9">  
      <asp:Panel ID="Panel1" runat="server" Height="490px">
          <asp:SqlDataSource ID="DS_Req_To_Dep" runat="server" ConnectionString="<%$ ConnectionStrings:ChngMgtConnectionString %>" OnSelecting="DS_Req_To_Dep_Selecting" SelectCommand="SELECT [Change_ID], [Summary] , [Creation_Date], [Priotity], Change.[Status], Change_Type.Type, Applications.Application,u1.User_Name Analyzed_By,u2.User_Name Authorized_By,u3.User_Name Developed_By,u4.User_Name QA_By 
FROM [Change] 
...
where  Change.Deploy_ID IS NULL and Change.App_ID IS NOT NULL and Change.Status='Approved'">
              <SelectParameters>
    ...
    <div class="row">
      <div class="col-md-10 col-lg-10">
        <div class="table-responsive">
            <asp:GridView ID="GridView1" runat="server" DataSourceID="DS_Req_To_Dep" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found" CssClass="table table-bordered table-condensed table-responsive table-striped" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowCommand="GridView1_OnRowCommand" DataKeyNames="Change_ID">
                <Columns>
    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you want to confirm of live migration? </p>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
                    <asp:Button ID="Button2" class="btn btn-primary" runat="server" Text="Yes" onclick="Dep_Click"/>
