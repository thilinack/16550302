...
public partial class BA_Pending_BA: System.Web.UI.Page
{
    static int change_id;
    Inputs input1 = new Inputs();
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["SUser_Label_Heading"] = "My Analysis";
        Session["Scrumble1_Heading"] = "My Analysis";
    }
    ...
    protected void BA_Click(object sender, EventArgs e)
    {
       // input1.BAChange(Convert.ToInt16(Session["User_ID"]), Convert.ToInt16(Session["id"]), "BA_Qualified", Convert.ToInt16(DropDownList1.SelectedValue));
        ...
        Response.Redirect("~/BA_My_BA_1.aspx");
