<%@ Page Title="" Language="C#" MasterPageFile="~/BA_Master_1.master" AutoEventWireup="true" CodeFile="BA_Pending_BA_1.aspx.cs" Inherits="BA_Pending_BA" %>
...
where  Change.BA_ID IS NULL and Change.Auth_ID IS NOT NULL and Change.Status='Authorized' and Change.Reassign=0;"></asp:SqlDataSource>

                    <div class="container">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="DS_Req_To_BA" CssClass="table table-bordered table-condensed table-responsive table-striped" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowCommand="GridView1_OnRowCommand" DataKeyNames="Change_ID">
                                        <Columns>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <asp:TextBox Text='<%# Bind("Summary") %>' runat="server" ID="SummaryTextBox" /><br />
                    ...
                    <h5>Assign to:</h5>
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource_Developer" DataTextField="User_Name" DataValueField="User_ID" Class="form-control"></asp:DropDownList>
