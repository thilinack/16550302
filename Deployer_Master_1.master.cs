...
public partial class Deployer_Master_1 : System.Web.UI.MasterPage
{
    SqlConnection con;
    ...
    {
        if (Session["LoginStatus"] == null || !Convert.ToBoolean(Session["LoginStatus"]) || Convert.ToInt16(Session["SAccess_ID"]) != 8)
        {
