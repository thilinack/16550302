<%@ Page Title="" Language="C#" MasterPageFile="~/BA_Master_1.master" AutoEventWireup="true" CodeFile="BA_My_BA_1.aspx.cs" Inherits="BA_Pending_BA" %>
...
<asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="Change_ID" CssClass="SlidingBox">
              ...
              <ItemTemplate>
                  ...
                  <asp:Label Text='<%# Bind("Approve_By") %>' runat="server" ID="Label7" /><br />
                          ...
                          <tr>
                            <td>
                    Development Assign To:
                                </td>
                            <td>
                  <asp:Label Text='<%# Bind("Assign_To") %>' runat="server" ID="Label9" /><br />
                            </td>
                            </tr>
...
Left JOIN  Users u9 ON Change.Dev_Assign = u9.User_ID 
