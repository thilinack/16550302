...
public partial class Requester_Master_2 : System.Web.UI.MasterPage
{
    ...
    {
        if (Session["LoginStatus"] == null || !Convert.ToBoolean(Session["LoginStatus"]) || Convert.ToInt16(Session["SUAccess_ID"]) != 2)
        {
