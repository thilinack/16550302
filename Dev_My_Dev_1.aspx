<%@ Page Title="" Language="C#" MasterPageFile="~/Dev_Master_1.master" AutoEventWireup="true" CodeFile="Dev_My_Dev_1.aspx.cs" Inherits="Dev_My_Dev" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box col-md-12 col-lg-12">  
      <asp:Panel ID="Panel1" runat="server" Height="490px">
          <asp:SqlDataSource ID="DS_My_Dev" runat="server" ConnectionString="<%$ ConnectionStrings:ChngMgtConnectionString %>" OnSelecting="DS_My_Dev_Selecting" SelectCommand="SELECT [Change_ID], [Summary] , [Creation_Date], [Priotity], Change.[Status], Change_Type.Type, Applications.Application,u1.User_Name Requested_By,u2.User_Name Authorized_By 
FROM [Change] 
...
where  Change.Dev_ID = @user_id;">
             ...
             <div class="container">
    <div class="row">
      <div class="box col-md-10 col-lg-10">
        <div class="table-responsive">
            <asp:GridView ID="GridView1" runat="server" DataSourceID="DS_My_Dev" CssClass="table table-bordered table-condensed table-responsive table-striped" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowCommand="GridView1_OnRowCommand" DataKeyNames="Change_ID">
                <Columns>
