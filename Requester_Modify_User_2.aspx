<%@ Page Title="" Language="C#" MasterPageFile="~/Requester_Master_2.master" AutoEventWireup="true" CodeFile="Requester_Modify_User_2.aspx.cs" Inherits="Modify_Request_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="form-group">
       ...
       <div class="form-group">
        ...
        <asp:LinkButton  ID="Button2" runat="server" class="btn btn-primary btn-lg" OnClick="Button2_Click"><i class="glyphicon glyphicon-send icon-white"></i>&nbsp;Submit</asp:LinkButton>
