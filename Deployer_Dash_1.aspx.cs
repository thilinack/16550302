...
public partial class Deployer_Dash_1 : System.Web.UI.Page
{
    ...
    public static List<object> GetChartData()
    {
        ...
        query += " FROM Change where Deploy_ID =@deploy_id GROUP BY Status";
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ChngMgtConnectionString"].ToString()))
        {
            using (SqlCommand cmd = new SqlCommand(query))
            {
                ...
                cmd.Parameters.AddWithValue("@deploy_id", Convert.ToInt16(HttpContext.Current.Session["User_ID"]));
                cmd.Connection = con;
                con.Open();
