...
public partial class Deployer_Pending_App : System.Web.UI.Page
{
    static int change_id;
    Inputs input1 = new Inputs();
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["SUser_Label_Heading"] = "Pending Deployements";
        Session["Scrumble1_Heading"] = "Pending Deployements";
    }



    protected void DS_Req_To_Dep_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
    ...
    protected void Dep_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Deployer_Pending_Dep_1.aspx");
