<%@ Page Title="" Language="C#" MasterPageFile="~/QA_Master_1.master" AutoEventWireup="true" CodeFile="QA_Pending_QA_1.aspx.cs" Inherits="QA_Pending_Dev" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box col-md-10">  
      <asp:Panel ID="Panel1" runat="server" Height="490px">
          <asp:SqlDataSource ID="DS_Req_To_BA" runat="server" ConnectionString="<%$ ConnectionStrings:ChngMgtConnectionString %>" OnSelecting="DS_Req_To_QA_Selecting" SelectCommand="SELECT [Change_ID], [Summary] , [Creation_Date], [Priotity], Change.[Status], Change_Type.Type, Applications.Application,u1.User_Name Analyzed_By,u2.User_Name Authorized_By,u3.User_Name Developed_By 
FROM [Change] 
...
where  Change.QA_ID IS NULL and Change.Dev_ID IS NOT NULL and Change.Status='Developed'">
              <SelectParameters>
      ...
      <h5>Comments:</h5>
            ...
            <SelectParameters>
                <asp:Parameter Name="change_ID" />
                    ...
                    <hr />
                    <h5>Check List:</h5>
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="User Requirements Met" />&nbsp
                    <asp:CheckBox ID="CheckBox2" runat="server" Text="Use Test Data" />&nbsp
                    <asp:CheckBox ID="CheckBox3" runat="server" Text="Use Test Cases" /></br>
                    <asp:CheckBox ID="CheckBox4" runat="server" Text="Roll Back Required" />&nbsp
                    <asp:CheckBox ID="CheckBox5" runat="server" Text="No Impact over System" />
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="Button4" runat="server" class="btn btn-danger" Text="ReAnalyze" data-toggle="modal" OnClientClick="return false;" data-target="#myModal3" />
                    <asp:Button ID="Button5" runat="server" class="btn btn-danger" Text="ReDevelop" data-toggle="modal" OnClientClick="return false;" data-target="#myModal4" />
    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you want to confirm the Qulity Check of this Request? </p>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
                    <asp:Button ID="Button2" class="btn btn-primary" runat="server" Text="Yes" onclick="QA_Click"/>
    ...
    <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you want to re-assign this Request for Analysis? </p>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
                    <asp:Button ID="Button3" class="btn btn-primary" runat="server" Text="Yes" onclick="Reject_Analysis_Click"/>
    ...
    <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you want to re-assign this Request for development? </p>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
                    <asp:Button ID="Button6" class="btn btn-primary" runat="server" Text="Yes" onclick="Reject_Development_Click"/>
