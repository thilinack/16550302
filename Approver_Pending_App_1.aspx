<%@ Page Title="" Language="C#" MasterPageFile="~/Approver_Master_1.master" AutoEventWireup="true" CodeFile="Approver_Pending_App_1.aspx.cs" Inherits="Approver_Pending_App" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box col-md-12">  
      <asp:Panel ID="Panel1" runat="server" Height="490px">
          <asp:SqlDataSource ID="DS_Req_To_App" runat="server" ConnectionString="<%$ ConnectionStrings:ChngMgtConnectionString %>" OnSelecting="DS_Req_To_App_Selecting" SelectCommand="SELECT [Change_ID], [Summary] , [Creation_Date], [Priotity], Change.[Status], Change_Type.Type, Applications.Application,u1.User_Name Analyzed_By,u2.User_Name Authorized_By,u3.User_Name Developed_By,u4.User_Name QA_By 
FROM [Change] 
...
Left JOIN  Users u3 ON Change.Dev_ID = u3.User_ID
Left JOIN  Users u4 ON Change.QA_ID = u4.User_ID
where  Change.App_ID IS NULL and Change.UAT_ID IS NOT NULL and Change.Status='UAT Confirmed'">
              <SelectParameters>
    ...
    <div class="row">
      <div class="col-md-10">
        <div class="table-responsive">
            <asp:GridView ID="GridView1" runat="server" DataSourceID="DS_Req_To_App" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found" CssClass="table table-bordered table-condensed table-responsive table-striped" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowCommand="GridView1_OnRowCommand" DataKeyNames="Change_ID">
                <Columns>
                    ...
                    <asp:BoundField DataField="Developed_By" HeaderText="Developed By" SortExpression="Developed_By"></asp:BoundField>
                    <asp:BoundField DataField="QA_By" HeaderText="QA By" SortExpression="QA_By"></asp:BoundField>
              ...
              <ItemTemplate>
                  ...
                  <asp:Label Text='<%# Bind("Application") %>' runat="server" ID="ApplicationTextBox" /><br />
                    ...
                    Scheduled Release Date:
                            ...
                            <td>
                  <asp:Label Text='<%# Bind("Schedule_Release") %>' runat="server" ID="Label1" /><br />
                            </td>
                            </tr>
      ...
      <h5>Comments:</h5>
            ...
            <SelectParameters>
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="Button1" runat="server" class="btn btn-success" Text="Approve" data-toggle="modal" OnClientClick="return false;" data-target="#myModal2" />
    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you want to Approve this Request for live migration? </p>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
                    <asp:Button ID="Button2" class="btn btn-primary" runat="server" Text="Yes" onclick="App_Click"/>
    ...
    <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
                    <asp:Button ID="Button3" class="btn btn-primary" runat="server" Text="Yes" onclick="Reject_Approve_Click"/>
