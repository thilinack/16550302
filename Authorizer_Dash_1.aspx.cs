...
public partial class Authorizer_Dash_1 : System.Web.UI.Page
{
    ...
    public static List<object> GetChartData()
    {
        ...
        query += " FROM Change where Auth_ID =@auth_id GROUP BY Status";
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ChngMgtConnectionString"].ToString()))
        {
            using (SqlCommand cmd = new SqlCommand(query))
            {
                ...
                cmd.Parameters.AddWithValue("@auth_id", Convert.ToInt16(HttpContext.Current.Session["User_ID"]));
                cmd.Connection = con;
                con.Open();
    ...
    public static List<object> GetChartData2()
    {
        ...
        query += " FROM User_Request where Auth_By =@req_id GROUP BY Status";
        // string constr = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
        List<object> chartData = new List<object>();
        chartData.Add(new object[]
        {
