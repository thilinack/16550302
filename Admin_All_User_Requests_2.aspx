<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master_1.master" AutoEventWireup="true" CodeFile="Admin_All_User_Requests_2.aspx.cs" Inherits="All_User_Req_2" %>
    ...
    <div class="row">
      <div class="col-md-10">
        <div class="table-responsive">
            <asp:GridView ID="GridView1" runat="server" DataSourceID="My_Auth" CssClass="table table-bordered table-condensed table-responsive table-striped" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowCommand="GridView1_OnRowCommand" DataKeyNames="UserReq_ID">
                <Columns>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3>User Creation Request Details</h3>
                </div>
...
where UserReq_ID = @req_id ;"
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="BtnCreate" class="form-control btn-primary" runat="server" Text="Create" onclick ="Create_Click" />
