<%@ Page Title="" Language="C#" MasterPageFile="~/Authorizer_Master_2.master" AutoEventWireup="true" CodeFile="Authorizer_Pending_Auth_2.aspx.cs" Inherits="Authorizer_Pending_Auth_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box col-md-10">   
        ...
        <asp:SqlDataSource ID="Pending_Auth" runat="server" ConnectionString="<%$ ConnectionStrings:ChngMgtConnectionString %>" OnSelecting="Pending_Auth_Selecting" SelectCommand="SELECT [UserReq_ID], [Req_Date],User_Request.Req_Type,User_Request.Emp_No,CONCAT(User_Request.F_Name,' ',User_Request.L_Name) as Name,Departments.Department,User_Request.Designation,User_Request.Access_level ,Applications.Application, User_Request.[Status], [Priority],u2.User_Name as Approved_By,u1.User_Name as Request_By,User_Request.Approved_Date
FROM [User_Request] 
...
where u1.Department_ID = @dep_id and User_Request.Approved_By IS NULL;">
            <SelectParameters>
